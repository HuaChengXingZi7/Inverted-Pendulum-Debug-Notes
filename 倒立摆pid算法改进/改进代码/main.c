...
//		AngelPID.Kd =RP_GetValue(3) / 4095.0 * 1 ; 
		...
		AngelPID.FilterCoeff =RP_GetValue(1) / 4095.0 * 1 ; 
		LocationPID.FilterCoeff =RP_GetValue(2) / 4095.0 * 1 ; 
...
//		OLED_Printf(0, 28, OLED_6X8,"kd:%05.3f",AngelPID.Kd);
		OLED_Printf(0, 12, OLED_6X8,"Tar:%04.0f",AngelPID.Target);
		OLED_Printf(0, 20, OLED_6X8,"Act:%04d",Angel);
		OLED_Printf(0, 28, OLED_6X8,"Out:%+04.0f",AngelPID.Out);
		OLED_Printf(0, 54, OLED_6X8,"Fil:%+05.3f",AngelPID.FilterCoeff);
...
//		OLED_Printf(64, 28, OLED_6X8,"kd:%05.3f",LocationPID.Kd);
		OLED_Printf(64, 12, OLED_6X8,"Tar:%+05.0f",LocationPID.Target);
		OLED_Printf(64, 20, OLED_6X8,"Act:%+05d",Location);
		OLED_Printf(64, 28, OLED_6X8,"Out:%+04.0f",LocationPID.Out);
		OLED_Printf(64, 54, OLED_6X8,"Fil:%+05.3f",LocationPID.FilterCoeff);
