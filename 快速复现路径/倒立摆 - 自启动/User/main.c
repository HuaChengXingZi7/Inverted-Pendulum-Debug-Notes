...
#define SET_PWM_SPEED	35
#define SET_COUNT_TIME	100
...
{
	static uint16_t Count0, Count1, Count2,SET_PWM_TIME;
	static uint16_t Angel0, Angel1, Angel2;
	...
	else if( RunState == 1 )
	{
		...
		if(Count0 >=40)
		{
			...
			if(Angel0 > CENTER_ANGEL+CENTER_RANGE&&
			   Angel1 > CENTER_ANGEL+CENTER_RANGE&&
			   Angel2 > CENTER_ANGEL+CENTER_RANGE&&
			   Angel1 < Angel0&&
		       Angel1 < Angel2	)
			{
				RunState = 21;
			...
			if(Angel0 > CENTER_ANGEL-CENTER_RANGE&&
			   Angel0 < CENTER_ANGEL+CENTER_RANGE&&
			   Angel1 > CENTER_ANGEL-CENTER_RANGE&&
			   Angel1 < CENTER_ANGEL+CENTER_RANGE&&
			   Angel2 > CENTER_ANGEL-CENTER_RANGE&&
			   Angel2 < CENTER_ANGEL+CENTER_RANGE)
	...
	{
		SET_PWM_TIME = SET_COUNT_TIME;
		Motor_SetPWM(SET_PWM_SPEED);
		RunState = 22;
	}	
	else if( RunState == 22 )
	{
